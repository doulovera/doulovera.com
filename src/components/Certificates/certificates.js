const certificates = [
  {
    name: 'Git y Github',
    platform: 'Platzi',
    platformUrl: 'https://platzi.com/p/douglaslovera/curso/1557-git-github/diploma/detalle/',
    url: 'https://drive.google.com/file/d/1kz_VYyJ174-GWxSomx8OYveFAaAT6EcL/view?usp=sharing',
  },
  {
    name: 'React.js',
    platform: 'Platzi',
    platformUrl: 'https://platzi.com/p/douglaslovera/curso/1548-course/diploma/detalle/',
  ...
  },
  {
    name: 'Webpack',
    platform: 'Platzi',
    platformUrl: 'https://platzi.com/p/douglaslovera/curso/2242-webpack/diploma/detalle/',
